...
void ResourceManager::LoadSounds()
{
	...
	instance->m_sounds.insert(std::pair<eSounds, sf::SoundBuffer*>(eSounds::menuConfirm, new sf::SoundBuffer()));
	instance->m_sounds[eSounds::menuConfirm]->loadFromFile(AssetPath() + "Sounds\\menu_confirm.wav");
	...
	instance->m_sounds.insert(std::pair<eSounds, sf::SoundBuffer*>(eSounds::scroll, new sf::SoundBuffer()));
	instance->m_sounds[eSounds::scroll]->loadFromFile(AssetPath() + "Sounds\\menu_scroll.wav");
}
